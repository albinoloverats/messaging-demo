...
import net.albinoloverats.messaging.demo.producer.Ama;
import net.albinoloverats.messaging.demo.producer.Axon;
import net.albinoloverats.messaging.demo.producer.Kafka;
...
public class Comparison
{
	...
	@Autowired
	private Ama amaService;
	@Autowired(required = false)
	private Axon axonService;
	@Autowired(required = false)
